# SCN
# API call to map OMIM to HPO terms
#' @input csv where each row is a variant ID and OMIM term ID (col pheno)
#' @return list of input length (i.e. number of variants) with propagated hpo terms for each variant, stored as R object set_terms
...
# export
save(set_terms, file = "pheno/set_terms.RData")
